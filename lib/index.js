 ...
 */
var methods = {
  lowerCase: [maps.COMMON_NAME, 'latin', 'cyrillyc'],
  upperCase: [maps.COMMON_NAME, 'LATIN', 'CYRILLYC'],
  latin: [maps.COMMON_NAME, 'latin', 'LATIN'],
  latinLowerCase: [maps.COMMON_NAME, 'latin'],
  cyrillyc: [maps.COMMON_NAME, 'cyrillyc', 'CYRILLYC'],
  cyrillycLowerCase: [maps.COMMON_NAME, 'cyrillyc']
};
