...
maps.NAMES = ['common', 'LATIN', 'latin', 'CYRILLIC', 'cyrillic'];
maps.COMMON_NAME = 'common';
...
// for (var c in maps.cyrillyc) {
//   var value = maps.cyrillyc[c];
//   console.log("'"+c.toLowerCase()+"':"+ '"'+string_as_unicode_escape(value.toLowerCase())+'"');
// }
